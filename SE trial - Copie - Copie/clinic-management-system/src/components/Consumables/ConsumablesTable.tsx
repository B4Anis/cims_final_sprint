                ...
                <tbody>
                    {consumable.map(Consumables => (
                        <tr key={Consumables.name}>
                            ...
                            <td>{Consumables.minStock}</td>
                            <td>{new Date(Consumables.expiryDate).toLocaleDateString()}</td>
                            <td>{Consumables.supplierName}</td>
                            <td>{Consumables.supplierContact}</td>
                            {!isDepUser && (
                                <td>
                                    <button
