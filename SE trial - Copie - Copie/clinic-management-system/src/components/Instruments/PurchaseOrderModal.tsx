...
export const PurchaseOrderModal: React.FC<PurchaseOrderModalProps> = ({
    ...
    const updateItem = (index: number, field: keyof PurchaseOrderItem, value: string | number) => {
        ...
        //     if (i === index) {
        //         if (field === 'InstrumentsId') {
        //             const Instruments = Instruments.find(med => med.id === value);
        //             return {
        //                 ...item,
        //                 InstrumentsId: value as string,
                    ...
                    <div className="items-section">
                        ...
                        {items.map((item, index) => (
                            <div key={index} className="purchase-order-item">
                                < select
                                    // // value={item.InstrumentsId}
                                    // onChange={(e) => updateItem(index, 'InstrumentsId', e.target.value)}
                                    // required
                                >
                                    <option value="">Select Instruments</option>
                                    {Instrumentss.map(med => (
